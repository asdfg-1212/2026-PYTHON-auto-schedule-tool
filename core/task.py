...
class Task:
    ...
    支持：
        ...
        - 备注（可选）
    """
    def __init__(self, name, estimated_time, importance, deadline=None, completed=False, note=None, task_id=None):
        self.name = name  # 任务名称
    ...
    def __repr__(self):
        return f"Task(name={self.name}, estimated_time={self.estimated_time}, importance={self.importance}, deadline={self.deadline}, completed={self.completed})"
